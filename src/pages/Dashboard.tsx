...
import FavoriteRecipesWidget from "@/components/dashboard/FavoriteRecipesWidget";
...
export default function Dashboard() {
  ...
  // Prepare mock recipes with some favorites
  const [recipes, setRecipes] = useState(() => {
    return mockRecipes.map((recipe, index) => ({
      ...recipe,
      isFavorite: index < 2 // Make the first two recipes favorites for demo
    }));
  });
  ...
  const handleToggleFavorite = (id: string | number, isFavorite: boolean) => {
